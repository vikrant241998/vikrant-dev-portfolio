...
const [formData, setFormData] = useState({
  ...
  const handleSubmit = (e) => {
    ...
    if (validate()) {
      // Alert Show karein
      setAlert({ show: true, message: 'Message sent successfully! We will contact you soon.', type: 'success' });
   ...
   <div className="contact-form-container">
      ...
      {alert.show && (
        <div className={`form-alert ${alert.type}`}>
          {alert.message}
          <button className="close-alert" onClick={() => setAlert({ ...alert, show: false })}>×</button>
        </div>
      )}
      ...
      <form className="contact-form" onSubmit={handleSubmit} noValidate>
        <div className="input-row">
          <div className="input-group">
            ...
            <input type="text" name="name" value={formData.name} onChange={handleChange} placeholder="Enter Your Name" className={errors.name ? 'input-error' : ''} />
        ...
        <div className="input-row">
          <div className="input-group">
            ...
            <input type="text" name="phone" value={formData.phone} onChange={handleChange} placeholder="Enter Your Number" className={errors.phone ? 'input-error' : ''} />
            {errors.phone && <span className="error-msg">{errors.phone}</span>}
          </div>
          <div className="input-group">
            <label>Subject <span>*</span></label>
            <input type="text" name="subject" value={formData.subject} onChange={handleChange} placeholder="I want to contact for..." className={errors.subject ? 'input-error' : ''} />
        ...
        <div className="input-group full-width">
          ...
          <textarea name="message" value={formData.message} onChange={handleChange} placeholder="Your message here...." className={errors.message ? 'input-error' : ''}></textarea>
